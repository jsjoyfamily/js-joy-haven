      ...
      <section className="relative py-20 lg:py-32 bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-50 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl lg:text-2xl text-gray-600 mb-12 max-w-4xl mx-auto leading-relaxed">
            From tuition information to daily communication, we've made it easy
            for parents to stay connected and informed about their child's care
            and development.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Our competitive rates include everything your child needs for a
              nurturing and educational experience. No hidden fees, no
              surprises.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            {tuitionRates.map((rate, index) => (
              ...
              >
                <div
                  className={`h-2 ${index === 0 ? "bg-pink-500" : index === 1 ? "bg-blue-500" : "bg-green-500"}`}
                ></div>
            ...
            <div>
              ...
              <div className="space-y-6">
                {paymentOptions.map((option, index) => (
                  <Card
                    key={index}
                    className="border-l-4 border-green-500 hover:shadow-lg transition-all duration-300"
                  >
                ...
                <CardContent className="p-8">
                  ...
                  <div className="mt-6 pt-6 border-t text-center">
                    <p className="text-sm text-gray-600 italic">
                      No additional fees for supplies, activities, or field
                      trips
                    </p>
                  </div>
                </CardContent>
      ...
      <section id="calendar" className="py-20 bg-gradient-to-br from-blue-50 to-indigo-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Never miss important dates, special events, or celebrations. Our
              calendar keeps you updated on everything happening at Joy Family
              Daycare.
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              We believe parents should never wonder what their child is doing.
              Our comprehensive communication system keeps you informed and
          ...
          <div className="bg-gradient-to-r from-purple-500 to-blue-500 rounded-2xl p-8 text-white">
            <div className="text-center mb-8">
              ...
              <p className="text-purple-100 max-w-2xl mx-auto">
                Everything you need to support your child's development at home
                and stay informed about our programs.
              </p>
            </div>
      ...
      <section className="py-20 bg-gradient-to-r from-orange-500 to-pink-500 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl lg:text-2xl text-white/90 mb-10 max-w-3xl mx-auto leading-relaxed">
            We'd love to welcome you and your child to Joy Family Daycare.
            Contact us today to schedule a visit and learn more about
            enrollment.
          </p>
