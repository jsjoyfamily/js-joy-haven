      ...
      <section className="py-20 bg-gradient-to-br from-yellow-50 to-orange-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-12">
            <a
              href="https://www.google.com/search?q=Js+Joy+Family+Daycare+Reviews"
              target="_blank"
              rel="noopener noreferrer"
            ...
            >
              ...
              <span className="text-sm font-semibold text-gray-700">Read Google Reviews</span>
              <span className="text-xs bg-yellow-100 text-yellow-800 px-2 py-0.5 rounded-full font-medium">5.0 ★ · 6 reviews</span>
            </a>
            <a
