          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mt-6 leading-relaxed">
                A small family home daycare run by experienced & certified
                professionals. We offer children a safe, supportive and friendly
                learning environment perfect for families seeking a home-like
                setting with small group sizes.
              </p>
              ...
              <div className="flex items-center gap-6 mt-8 pt-8 border-t border-gray-200">
                <div className="text-center">
                  <div className="text-2xl font-bold text-joy-orange">
                    6mo-4yr
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We provide a loving, safe environment where children can learn,
              grow, and thrive
            </p>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Age-appropriate programs designed to support your child's
          ...
          <div className="text-center mt-12">
            <Button
              asChild
              size="lg"
              className="bg-joy-blue hover:bg-joy-blue/90"
            >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                With over 15 years of experience in childcare, we understand
                that choosing the right daycare for your child is one of the
                most important decisions you'll make as a parent. That's why
                we've created a warm, nurturing environment that feels like a
                second home.
              </p>
              <div className="space-y-4 mb-8">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-700">
                    Flexible Hours: 7:00 AM - 6:00 PM
                  </span>
                </div>
                <div className="flex items-center space-x-3">
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="border-joy-orange text-joy-orange hover:bg-joy-orange hover:text-white"
              >
                ...
                <CardContent className="p-6">
                  <div className="flex mb-4">
                    {[...Array(testimonial.rating)].map((_, i) => (
                      <Star
                        key={i}
                        className="w-5 h-5 fill-joy-orange text-joy-orange"
                      />
                    ))}
                  </div>
      ...
      <section className="py-16 bg-joy-orange">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            ...
            Contact us today to schedule a visit and see the difference we can
            make.
          </p>
