      ...
      <section className="relative py-20 lg:py-32 bg-gradient-to-br from-orange-50 via-pink-50 to-purple-50 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl lg:text-2xl text-gray-600 mb-12 max-w-4xl mx-auto leading-relaxed">
            For over 15 years, we've been providing exceptional childcare in a warm, family-oriented environment. Our mission is to nurture young minds and hearts while giving parents complete peace of mind.
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-6 text-lg text-gray-600 leading-relaxed">
                <p>
                  Joy Family Daycare was founded in 2009 with a simple but powerful vision: to create a place where children could thrive in a loving, home-like environment while receiving quality early childhood education.
                </p>
                <p>
                  As parents ourselves, we understand the challenges of finding trustworthy, high-quality childcare. That's why we've dedicated ourselves to creating a program that treats every child like family and partners with parents to support their child's growth and development.
                </p>
                <p>
                  Our small group sizes allow us to provide individualized attention that larger centers simply cannot offer. We believe that every child is unique and deserves care that honors their individual personality, interests, and developmental timeline.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-orange-100 to-pink-100 rounded-3xl p-8 shadow-lg">
                <div className="text-center mb-6">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Building strong foundations through love, learning, and laughter every single day.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-white rounded-lg p-4 text-center">
                    ...
                    <div className="text-sm font-semibold text-gray-900">Nurturing Care</div>
                  </div>
                  <div className="bg-white rounded-lg p-4 text-center">
                    <BookOpen className="w-8 h-8 text-blue-500 mx-auto mb-2" />
                    <div className="text-sm font-semibold text-gray-900">Learning Focus</div>
                  </div>
                  <div className="bg-white rounded-lg p-4 text-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              These principles shape every interaction, every lesson, and every moment your child spends in our care.
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Our experienced, passionate team members are the heart of Joy Family Daycare. Each brings unique skills and unwavering dedication to your child's development.
            </p>
          </div>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-center">
                    <div className="bg-gray-50 rounded-lg p-3">
                      ...
                      <div className="text-xs text-gray-600">{member.experience}</div>
                    </div>
                    <div className="bg-gray-50 rounded-lg p-3">
      ...
      <section className="py-20 bg-gradient-to-br from-blue-50 to-purple-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              We maintain the highest standards through proper licensing, ongoing training, and commitment to excellence in early childhood education.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {certifications.map((cert, index) => (
              ...
              >
                ...
                <CardHeader>
                  <div className={`w-16 h-16 bg-gradient-to-r ${cert.color} rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg`}>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Every year has brought new achievements, growth, and opportunities to serve families in our community.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="relative">
              <div className="bg-gradient-to-br from-green-100 to-blue-100 rounded-3xl p-8 text-center shadow-lg">
                ...
                <p className="text-gray-600 leading-relaxed mb-6">
                  Our facility combines the warmth of a family home with the safety and resources of a professional childcare center.
                </p>
                <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Every space in our facility has been thoughtfully designed to encourage exploration, creativity, and learning while maintaining the highest safety standards.
              </p>
      ...
      <section className="py-20 bg-gradient-to-r from-orange-500 to-pink-500 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl lg:text-2xl text-white/90 mb-10 max-w-3xl mx-auto leading-relaxed">
            We'd love to meet you and your child. Schedule a visit to see our facility, meet our team, and learn more about our programs.
          </p>
