  ...
  const galleryImages = [
    {
      ...
      category: "facility",
      description: "Our colorful and safe indoor play space where children explore and learn together."
    },
    {
      id: 2,
      src: "/placeholder.svg",
      ...
      category: "outdoor",
      description: "Secure outdoor area with age-appropriate equipment for physical development."
    },
    {
      id: 3,
      src: "/placeholder.svg",
      ...
      category: "learning",
      description: "Daily story time sessions that build language skills and imagination."
    },
    {
      id: 4,
      src: "/placeholder.svg",
      ...
      category: "arts",
      description: "Hands-on art activities that encourage creativity and fine motor skills."
    },
    {
      id: 5,
      src: "/placeholder.svg",
      ...
      category: "meals",
      description: "Nutritious meals and snacks prepared fresh daily in our licensed kitchen."
    },
    {
      id: 6,
      src: "/placeholder.svg",
      ...
      category: "activities",
      description: "Sensory bins and activities that support cognitive development."
    },
    {
      id: 7,
      src: "/placeholder.svg",
      ...
      category: "facility",
      description: "Cozy reading nook where children develop early literacy skills."
    },
    {
      id: 8,
      src: "/placeholder.svg",
      ...
      category: "activities",
      description: "Fun music sessions that promote rhythm, coordination, and joy."
    },
    {
      id: 9,
      src: "/placeholder.svg",
      ...
      category: "outdoor",
      description: "Hands-on learning about plants, insects, and the natural world."
    },
    {
      id: 10,
      src: "/placeholder.svg",
      ...
      title: "Dramatic Play",
      category: "activities",
      description: "Imaginative play area where children explore different roles and scenarios."
    },
    {
      id: 11,
      src: "/placeholder.svg",
      ...
      category: "learning",
      description: "Early engineering and math concepts through hands-on building activities."
    },
    {
      id: 12,
      src: "/placeholder.svg",
      ...
      category: "facility",
      description: "Peaceful rest area where children recharge with quiet activities or naps."
    },
  ];
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="mb-8">
              ...
              <p className="text-xl text-gray-700 max-w-3xl mx-auto leading-relaxed">
                Take a peek into our vibrant learning environment where children play, learn, and grow every day. 
                See the joy and wonder that fills our home daycare.
              </p>
            </div>
        ...
        <section className="py-12">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Explore Our Spaces</h2>
              <p className="text-gray-600 max-w-2xl mx-auto">
                Browse through different areas of our daycare to see how we create 
                meaningful learning experiences for every child.
              </p>
            </div>
            ...
            {filteredImages.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="text-gray-500">We're constantly adding new photos. Check back soon!</p>
              </div>
            )}
          </div>
        </section>
        ...
        <section className="py-16 bg-gradient-to-r from-orange-500 to-pink-500 text-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="mb-8">
              ...
              <h2 className="text-4xl font-bold mb-4">See Our Home in Person</h2>
              <p className="text-xl text-white/90 leading-relaxed">
                Pictures can only show so much! We'd love to welcome you for a personal tour 
                where you can experience the warmth and care that makes our daycare special.
              </p>
            </div>
